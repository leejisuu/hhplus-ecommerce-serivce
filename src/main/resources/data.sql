...
insert into point (id, user_id, point, version, created_at, updated_at) values
(1, 1, 2500, 0, NOW(), NOW()),
(2, 2, 0, 0, NOW(), NOW()),
(3, 3, 50000, 0, NOW(), NOW()),
(4, 4, 3500, 0, NOW(), NOW()),
...
INSERT INTO product_stock (id, product_id, quantity, version, created_at, updated_at) VALUES
(1, 1, 9999, 0,NOW(), NOW()),
(2, 2, 2, 0, NOW(), NOW()),
(3, 3, 500, 0,NOW(), NOW()),
(4, 4, 1500, 0, NOW(), NOW()),
...
INSERT INTO coupon (id, name, discount_type, discount_amt, max_capacity, remain_capacity, valid_started_at, valid_ended_at, status, version, created_at, updated_at) VALUES
(1, '생일 쿠폰', 'FIXED_AMOUNT', 3000, 3, 3, '2025-01-01 00:00:00', '2025-01-31 23:59:59', 'ACTIVE', 0, NOW(), NOW()),
(2, 'S 브랜드 할인 쿠폰', 'PERCENTAGE', 10, 3, 0, '2025-01-10 00:00:00', '2025-02-28 23:59:59', 'ACTIVE', 0, NOW(), NOW()),
(3, '첫 구매 감사 쿠폰', 'FIXED_AMOUNT', 5000, 3, 3, '2025-01-05 00:00:00', '2025-03-31 23:59:59', 'ACTIVE', 0, NOW(), NOW()),
(4, 'VIP 회원 한정 쿠폰', 'PERCENTAGE', 20, 3, 3, '2025-01-15 00:00:00', '2025-06-30 23:59:59', 'ACTIVE', 0, NOW(), NOW()),
(5, '겨울 시즌 할인 쿠폰', 'PERCENTAGE', 15, 3, 2, '2025-01-01 00:00:00', '2025-02-28 23:59:59', 'ACTIVE', 0, NOW(), NOW()),
(6, '특가 상품 추가 할인 쿠폰', 'FIXED_AMOUNT', 2000, 3, 3, '2025-01-10 00:00:00', '2025-04-30 23:59:59', 'DEACTIVATED', 0, NOW(), NOW()),
(7, '이벤트 참여 감사 쿠폰', 'PERCENTAGE', 5, 3, 3, '2025-01-01 00:00:00', '2025-07-31 23:59:59', 'ACTIVE', 0, NOW(), NOW()),
(8, '블랙프라이데이 쿠폰', 'PERCENTAGE', 30, 3, 2, '2025-01-05 00:00:00', '2025-01-10 00:00:01', 'ACTIVE', 0, NOW(), NOW()),
(9, '한정판 출시 기념 쿠폰', 'FIXED_AMOUNT', 10000, 3, 3, '2025-01-12 00:00:00', '2025-03-15 23:59:59', 'ACTIVE', 0, NOW(), NOW()),
(10, '멤버십 가입 축하 쿠폰', 'FIXED_AMOUNT', 7000, 3, 3, '2025-01-07 00:00:00', '2025-03-31 23:59:59', 'DEACTIVATED', 0, NOW(), NOW());
...
(5, 3, 3, '첫 구매 감사 쿠폰', 'FIXED_AMOUNT', 5000, '2025-01-10 00:00:00', '2025-01-05 00:00:00', '2025-03-31 23:59:59', null ,'UNUSED', NOW(), NOW());
